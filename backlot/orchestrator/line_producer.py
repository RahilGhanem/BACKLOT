...
def _schedule_fingerprint(schedule: Schedule) -> tuple:
    """A cheap structural signature for fixed-point detection: same day count,
    same location/time-of-day per day, same scenes per day."""
...
class LineProducer(BaseAgent):
    ...
    async def _run_async_impl(
        ...
        previz_agent = by_name.get("previz_agent")
